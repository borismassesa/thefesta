      ...
      <div className="grid gap-5 xl:grid-cols-[1fr_360px]">
        <div className="space-y-5">
          <section className="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              {canSubmit && ['draft', 'changes_requested'].includes(requisition.status) && <form action={submitAction}><button className="rounded-xl bg-[#5B2D8E] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#492270]">Submit for approval</button></form>}
            </div>
        ...
        <aside className="space-y-5">
          <section className="rounded-2xl border border-gray-100 bg-white p-5 shadow-sm">
            <h2 className="text-base font-semibold text-gray-950">Approval route</h2>
