...
export const RECRUITMENT_KEYS = [
  ...
  'workforce.requisitions.read',
  'workforce.requisitions.create',
  ...
  'workforce.candidates.read',
  'workforce.candidates.write',
  'workforce.candidates.export',
  'workforce.candidates.merge',
  'workforce.candidates.delete',
  'workforce.applications.read',
  'workforce.applications.review',
  'workforce.applications.advance',
  'workforce.applications.reject',
  'workforce.interviews.read',
  'workforce.interviews.schedule',
  'workforce.interviews.score',
  'workforce.assessments.read',
  'workforce.assessments.write',
  'workforce.assessments.score',
  'workforce.offers.read',
  'workforce.offers.create',
  'workforce.offers.approve',
  'workforce.offers.send',
  'workforce.offers.compensation_read',
  'workforce.talent_pool.read',
  'workforce.talent_pool.write',
  'workforce.referrals.read',
  'workforce.referrals.admin',
  'workforce.careers_content.read',
