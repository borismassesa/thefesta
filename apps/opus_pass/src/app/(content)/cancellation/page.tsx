...
const pageMetadata: Record<Locale, Metadata> = {
  ...
  sw: {
    title: 'Sera ya Kufuta na Kurejesha Fedha | OpusPass',
    description:
      'Jinsi kufuta oda na kurejesha fedha kunavyofanyika kwa vifurushi, huduma za ziada, na kadi zilizochapishwa za OpusPass.',
  },
}
...
const copy: Record<Locale, CancellationCopy> = {
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: (
          <p>
            Because your digital cards are online, you can <strong>update event details — venue, date, or
  ...
  sw: {
    eyebrow: 'Kisheria',
    title: 'Sera ya Kufuta na Kurejesha Fedha',
    updated: 'Juni 2026',
    intro: (
      <p>
        Sera hii inaeleza jinsi kufuta oda na kurejesha fedha kunavyofanyika kwa vifurushi vya
        kidijitali vya OpusPass, huduma za ziada, na kadi zilizochapishwa.
      </p>
    ),
    labels: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: (
          <p>
            Kwa sababu kadi zako za kidijitali zipo mtandaoni, unaweza <strong>kubadilisha taarifa za tukio — ukumbi,
            tarehe, au muda — bila gharama</strong>, hata baada ya mialiko kutumwa. Kila mgeni ataona mabadiliko
            mara moja, hivyo kupanga upya tarehe hakumaanishi kununua tena.
          </p>
        ),
      },
      {
